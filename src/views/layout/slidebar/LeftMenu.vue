  ...
  <ul class="sidebar-menu">
    ...
    <li class="active treeview">
      ...
      <ul class="treeview-menu">
        ...
        <li><a><i class="fa fa-circle-o"></i><router-link to='/bidding/abolish'>招标项目流标</router-link></a></li>
    ...
    <li class="treeview">
      ...
      <ul class="treeview-menu">
        ...
        <li><a><i class="fa fa-circle-o"></i><router-link to='/system/setting'>银行账户配置</router-link></a></li>
      </ul>
    </li>
    <li class="treeview">
      <a href="#">
      ...
      <ul class="treeview-menu">
        <li><a><i class="fa fa-circle-o"></i>略</a></li>
      </ul>
    </li>
